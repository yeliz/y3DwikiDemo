package
{
	...
	import com.yogurt3d.core.materials.MaterialEmptyContour;
	...
	public class wikiEmptyContour extends BaseTest
	{
		...
		public override function createSceneObjects(e:Event = null):void{
			...
			m_loader.addEventListener( LoaderEvent.ALL_COMPLETE, function( _e:LoaderEvent ):void
			{
				...
				m_sceneObject.material = new MaterialEmptyContour();
		...
		private function createUI():void{
			...
			window = new Window(this,  m_resourceManager.windowX, m_resourceManager.windowY,"EmptyContour Properties");
			...
			alphaSlider = new HSlider(window, 5, 30, function(_e:Event):void{
				...
				MaterialEmptyContour(m_sceneObject.material).opacity = alphaSlider.value;
			});
			...
			tLabel = new Label(window, 5, 50,"Thickness");
			thickenessSlider = new HSlider(window, 5, 65, function(_e:Event):void{
				MaterialEmptyContour(m_sceneObject.material).contourThickness = thickenessSlider.value;
			...
			c1Label = new Label(window, 5, 85,"ContColor");
			
			colorChooser = new ColorChooser( window, 5, 100, 0x000000, function(_e:Event):void{
				MaterialEmptyContour(m_sceneObject.material).contourColor =  colorChooser.value;
			});
