package
{
	...
	import com.yogurt3d.core.materials.MaterialSpecularFillVertex;
	...
	public class wikiSpecularFillVertex extends BaseTest
	{
		...
		public function wikiSpecularFillVertex()
		{
		...
		private function createUI():void{
			...
			window = new Window(this, m_resourceManager.windowX, m_resourceManager.windowY,"SpecularFillVertex Properties");
			...
			alphaSlider = new HSlider(window, 5, 30, function(_e:Event):void{
				...
				MaterialSpecularFillVertex(m_sceneObject.material).opacity = alphaSlider.value;
			});
			...
			new Label(window,5,75,"Shininess");
			var slider4:Slider = new Slider( "horizontal", window, 5, 95, function():void{
				MaterialSpecularFillVertex(m_sceneObject.material).shininess= slider4.value;
			});
			slider4.value = MaterialSpecularFillVertex(m_sceneObject.material).shininess;
			slider4.minimum = 5;
			slider4.maximum = 250;
