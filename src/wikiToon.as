package
{
	...
	import com.yogurt3d.core.materials.MaterialToon;
	...
	public class wikiToon extends BaseTest
	{
		...
		private var colorChooser2				:ColorChooser;
		...
		private function createUI():void{
			...
			window = new Window(this,m_resourceManager.windowX, m_resourceManager.windowY,"Toon Properties");
			...
			alphaSlider = new HSlider(window, 5, 30, function(_e:Event):void{
				...
				MaterialToon(m_sceneObject.material).opacity = alphaSlider.value;
			});
			...
			tLabel = new Label(window, 5, 45,"Thickness");
			thickenessSlider = new HSlider(window, 5, 60, function(_e:Event):void{
				MaterialToon(m_sceneObject.material).contourThickness = thickenessSlider.value;
			...
			c2Label = new Label(window, 5, 110,"Contour Color");
			colorChooser2 = new ColorChooser( window, 5, 125, 0x000000, function(_e:Event):void{
				MaterialToon(m_sceneObject.material).contourColor =  colorChooser2.value;
			});
